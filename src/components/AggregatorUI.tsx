...
export function AggregatorUI({ identity }: { identity: Identity }) {
  ...
  const tabs = [
    { id: AggregatorTab.HUB, label: 'Consensus', icon: Newspaper, color: 'text-blue-500' },
        ...
        <div className="flex flex-col h-full">
          <div className="p-6 flex items-center gap-3">
            ...
            <div>
              ...
              <span className="text-[10px] font-mono text-slate-500 uppercase tracking-widest">v1.1 Lattice</span>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="py-8 md:py-10 lg:py-12">
              <AnimatePresence mode="wait">
                {activeTab === AggregatorTab.HUB && <motion.div key="hub" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }}><ConsensusFeed /></motion.div>}
